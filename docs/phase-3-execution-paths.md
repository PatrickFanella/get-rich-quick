...
| ----- | ---------------------- | :----: | :----: | :-----: | -------- |
| A     | Pipeline Orchestration |   5    |   3    |    2    | Opus 4.6 |
| B     | Analysis Agents        |   9    |   5    |    4    | Mixed    |
| C1    | Research Debate        |   6    |   2    |    4    | Opus 4.6 |
| C2    | Trader Agent           |   1    |   1    |    0    | Opus 4.6 |
| C3    | Risk Debate            |   5    |   0    |    5    | Opus 4.6 |
...
| --- | ------------------------------------------------------------------- | ----------------------------------------------------------------- | :--: | ---------------- | ------- | -------- |
| 1   | [#158](https://github.com/PatrickFanella/get-rich-quick/issues/158) | Implement Phase 2 executor: research debate loop                  |  M   | None             | READY   | Opus 4.6 |
| 2   | [#159](https://github.com/PatrickFanella/get-rich-quick/issues/159) | Implement Phase 3 executor: trader agent                          |  XS  | None             | READY   | Opus 4.6 |
| 3   | [#160](https://github.com/PatrickFanella/get-rich-quick/issues/160) | Implement Phase 4 executor: risk debate loop                      |  M   | None             | READY   | Opus 4.6 |
| 4   | [#161](https://github.com/PatrickFanella/get-rich-quick/issues/161) | Implement top-level Pipeline.Execute method with phase sequencing |  M   | #158, #159, #160 | BLOCKED | Opus 4.6 |
...
| 2   | [#164](https://github.com/PatrickFanella/get-rich-quick/issues/164) | Write Market Analyst system prompt template                    |  XS  | None       | READY   | Opus 4.6 |
| 3   | [#165](https://github.com/PatrickFanella/get-rich-quick/issues/165) | Implement Market Analyst agent struct and Execute method       |  S   | #163, #164 | BLOCKED | Opus 4.6 |
| 4   | [#167](https://github.com/PatrickFanella/get-rich-quick/issues/167) | Write Fundamentals Analyst system prompt template              |  XS  | None       | READY   | Opus 4.6 |
| 5   | [#168](https://github.com/PatrickFanella/get-rich-quick/issues/168) | Implement Fundamentals Analyst agent struct and Execute method |  S   | #163, #167 | BLOCKED | Opus 4.6 |
| 6   | [#170](https://github.com/PatrickFanella/get-rich-quick/issues/170) | Write News Analyst system prompt template                      |  XS  | None       | READY   | Opus 4.6 |
| 7   | [#172](https://github.com/PatrickFanella/get-rich-quick/issues/172) | Implement News Analyst agent struct and Execute method         |  S   | #163, #170 | BLOCKED | Opus 4.6 |
| 8   | [#174](https://github.com/PatrickFanella/get-rich-quick/issues/174) | Write Social Media Analyst system prompt template              |  XS  | None       | READY   | Opus 4.6 |
| 9   | [#176](https://github.com/PatrickFanella/get-rich-quick/issues/176) | Implement Social Media Analyst agent struct and Execute method |  S   | #163, #174 | BLOCKED | Opus 4.6 |
...
| 3   | [#171](https://github.com/PatrickFanella/get-rich-quick/issues/171) | Write Bull Researcher system prompt and implement agent                                 |  S   | #169             | BLOCKED | Opus 4.6 |
| 4   | [#173](https://github.com/PatrickFanella/get-rich-quick/issues/173) | Write Bear Researcher system prompt and implement agent                                 |  S   | #169             | BLOCKED | Opus 4.6 |
| 5   | [#175](https://github.com/PatrickFanella/get-rich-quick/issues/175) | Write Research Manager system prompt and implement agent with structured output parsing |  M   | #169             | BLOCKED | Opus 4.6 |
| 6   | [#177](https://github.com/PatrickFanella/get-rich-quick/issues/177) | Implement research debate orchestration node                                            |  M   | #171, #173, #175 | BLOCKED | Opus 4.6 |
...
| #   | Issue                                                               | Title                                                                         | Size | Blocker | Status | Model    |
| --- | ------------------------------------------------------------------- | ----------------------------------------------------------------------------- | :--: | ------- | ------ | -------- |
| 1   | [#178](https://github.com/PatrickFanella/get-rich-quick/issues/178) | Write Trader agent system prompt and implement with structured output parsing |  M   | None    | READY  | Opus 4.6 |
...
| #   | Issue                                                               | Title                                                                       | Size | Blocker                | Status  | Model    |
| --- | ------------------------------------------------------------------- | --------------------------------------------------------------------------- | :--: | ---------------------- | ------- | -------- |
| 1   | [#179](https://github.com/PatrickFanella/get-rich-quick/issues/179) | Write Aggressive Risk Analyst system prompt and implement agent             |  S   | #169, #166             | BLOCKED | Opus 4.6 |
| 2   | [#180](https://github.com/PatrickFanella/get-rich-quick/issues/180) | Write Conservative Risk Analyst system prompt and implement agent           |  S   | #169, #166             | BLOCKED | Opus 4.6 |
| 3   | [#181](https://github.com/PatrickFanella/get-rich-quick/issues/181) | Write Neutral Risk Analyst system prompt and implement agent                |  S   | #169, #166             | BLOCKED | Opus 4.6 |
| 4   | [#183](https://github.com/PatrickFanella/get-rich-quick/issues/183) | Write Risk Manager system prompt and implement with final signal extraction |  M   | #169                   | BLOCKED | Opus 4.6 |
| 5   | [#185](https://github.com/PatrickFanella/get-rich-quick/issues/185) | Implement risk debate orchestration node                                    |  M   | #179, #180, #181, #183 | BLOCKED | Opus 4.6 |
...
| #   | Issue                                                               | Title                                                                 | Size | Blocker | Status  | Model    |
| --- | ------------------------------------------------------------------- | --------------------------------------------------------------------- | :--: | ------- | ------- | -------- |
| 1   | [#209](https://github.com/PatrickFanella/get-rich-quick/issues/209) | Implement risk engine: pre-trade validation and position limit checks |  M   | None    | READY   | Opus 4.6 |
| 2   | [#210](https://github.com/PatrickFanella/get-rich-quick/issues/210) | Implement risk engine: circuit breaker state machine                  |  M   | #209    | BLOCKED | Opus 4.6 |
| 3   | [#211](https://github.com/PatrickFanella/get-rich-quick/issues/211) | Implement risk engine: kill switch with three mechanisms              |  S   | #209    | BLOCKED | Opus 4.6 |
...
| 2   | [#208](https://github.com/PatrickFanella/get-rich-quick/issues/208) | Implement order state machine and lifecycle manager                       |  M   | #207    | BLOCKED | Opus 4.6 |
...
| #   | Issue                                                               | Title                                                                           | Size | Blocker | Status | Model    |
| --- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------- | :--: | ------- | ------ | -------- |
| 1   | [#212](https://github.com/PatrickFanella/get-rich-quick/issues/212) | Implement memory reflection: generate agent memories from trade outcomes        |  M   | None    | READY  | Opus 4.6 |
...
| Use Opus 4.6 for                                  | Use GPT-5.4 for                  |
| ------------------------------------------------- | -------------------------------- |
| Pipeline orchestration logic                      | HTTP clients and API adapters    |
| System prompts (agent personality/behavior)       | Math-heavy indicators            |
| Agent implementations (prompt + struct + execute) | Rate limiters, utility functions |
| Structured output parsing (JSON extraction)       | CRUD broker methods              |
| State machines (circuit breaker, order lifecycle) | Position sizing formulas         |
| Debate orchestration                              | Data provider implementations    |
| Memory reflection (LLM reasoning about outcomes)  | Caching and wiring               |
| Risk engine validation logic                      | Market hours checker, scheduler  |
...
| Issue                                                               | Track        | Model    |
| ------------------------------------------------------------------- | ------------ | -------- |
| [#158](https://github.com/PatrickFanella/get-rich-quick/issues/158) | A - Pipeline | Opus 4.6 |
...
| [#209](https://github.com/PatrickFanella/get-rich-quick/issues/209) | F - Risk     | Opus 4.6 |

### Wave 2 (after wave 1 merges)

| Issue                                                               | Track           | Model    | Unblocked by |
| ------------------------------------------------------------------- | --------------- | -------- | ------------ |
| [#159](https://github.com/PatrickFanella/get-rich-quick/issues/159) | A - Pipeline    | Opus 4.6 | —            |
| [#184](https://github.com/PatrickFanella/get-rich-quick/issues/184) | D1 - Polygon    | GPT-5.4  | #182         |
| [#197](https://github.com/PatrickFanella/get-rich-quick/issues/197) | D2 - Indicators | GPT-5.4  | —            |
| [#198](https://github.com/PatrickFanella/get-rich-quick/issues/198) | E1 - Alpaca     | GPT-5.4  | #196         |
| [#210](https://github.com/PatrickFanella/get-rich-quick/issues/210) | F - Risk        | Opus 4.6 | #209         |
| [#205](https://github.com/PatrickFanella/get-rich-quick/issues/205) | E3 - Paper      | GPT-5.4  | —            |

### Wave 3 (after wave 2)

| Issue                                                               | Track           | Model    | Unblocked by |
| ------------------------------------------------------------------- | --------------- | -------- | ------------ |
| [#160](https://github.com/PatrickFanella/get-rich-quick/issues/160) | A - Pipeline    | Opus 4.6 | —            |
| [#163](https://github.com/PatrickFanella/get-rich-quick/issues/163) | B - Analysts    | GPT-5.4  | —            |
| [#169](https://github.com/PatrickFanella/get-rich-quick/issues/169) | C1 - Debate     | GPT-5.4  | —            |
| [#166](https://github.com/PatrickFanella/get-rich-quick/issues/166) | C1 - Constants  | GPT-5.4  | —            |
...
| [#199](https://github.com/PatrickFanella/get-rich-quick/issues/199) | D2 - Indicators | GPT-5.4  | —            |
| [#211](https://github.com/PatrickFanella/get-rich-quick/issues/211) | F - Kill switch | Opus 4.6 | #209         |
| [#207](https://github.com/PatrickFanella/get-rich-quick/issues/207) | G - Pos sizing  | GPT-5.4  | —            |
